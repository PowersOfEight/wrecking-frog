...
/**
 <a href="https://youtu.be/dnNCVcVS6uw">Grappling Rope Tutorial</a>
 */
public class GrapplingTongue : MonoBehaviour
{
    ...
    void DrawRopeWaves()
    {
        for (int i = 0; i < precision; i++)
        {
            ...
            Vector2 currentPosition = Vector2.Lerp(mouth.firePoint.position, targetPosition, ropeProgressionCurve.Evaluate(moveTime) * tongueProgressionSpeed);
